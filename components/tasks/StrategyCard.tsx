...
export function StrategyCard({
  ...
  if (!strategy) {
    return (
      <div className="flex rounded-2xl border border-neutral-800 bg-neutral-900 overflow-hidden cursor-default">
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "flex rounded-2xl border border-neutral-800 bg-neutral-900 overflow-hidden",
        "hover:border-neutral-700 transition-colors duration-200 cursor-pointer",
      )}
    >
      {/* Vote column */}
      ...
      <div className="flex flex-col flex-1 min-w-0 py-4 pr-4 pl-1">
        ...
        {strategy.description && (
          <p className="text-sm text-neutral-400 leading-relaxed line-clamp-2 mt-1">
            {strategy.description}
          </p>
        )}
        ...
        {/* Thumbnail */}
        {thumbnailUrl ? (
          <div className="mt-3 aspect-video max-h-[160px] overflow-hidden rounded-lg bg-neutral-800">
          ...
          <div className="mt-3 aspect-video max-h-[160px] rounded-lg bg-neutral-800 border border-neutral-700 flex items-center justify-center">
            <svg
