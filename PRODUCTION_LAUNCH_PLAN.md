...
**Verifica:**
- [ ] Richiesta da `https://relay.app` funziona
...
- [ ] Configurare monitor per:
  - Homepage: `https://relay.app/`
  - API health: `https://relay.app/api/health`
  - Login page: `https://relay.app/login`
- [ ] Configurare alert:
  - Email quando down
  - SMS (se critico)
